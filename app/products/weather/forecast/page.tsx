  ...
  return (
    <>
      ...
      <article>
        ...
        <h3 className="text-lg font-bold text-white mb-3" style={{ textAlign: 'center' }}>
          <div id="navbarNav">
              <Link href="/products/weather" className="nav-link" style={{ marginRight: "15px" }}>Live Radar</Link>  7 Day Forecast</div>
            </h3>
            <div className="mb-8 rounded-2xl border border-slate-200 bg-slate-50 p-4 text-sm text-slate-600" style={{ padding: "10px" }}>
