    ...
    <><ResponsiveAppBar />
      ...
      <article>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <section className="md:col-span-2 bg-gradient-to-br from-slate-900 via-indigo-950 to-slate-900 border border-indigo-900/50 p-8 rounded-md shadow-xl flex flex-col justify-between relative overflow-hidden" style={{ padding: '15px' }}>
                <p className="text-sm text-emerald-400 font-mono mt-1">📍 Station Active (UTC Offset: {weather.location?.utc_offset_seconds}s)</p>
          
          <div className="text-left sm:text text-xs text-slate-400 font-mono space-y-0.5">
            ...
            <p>Lon: {weather.location?.longitude?.toFixed(4)}°</p>
             ...
             {/*  <div className="absolute top-0 right-0 p-8 text-7xl opacity-20 pointer-events-none select-none">
              ...
              <div>
                ...
                <h2 className="text-5xl font-black tracking-tight text-white mt-2" style={{color: 'white'}}>
            ...
            <section className="bg-slate-900 border border-slate-800 p-6 rounded-md shadow-xl flex flex-col justify-between" style={{ padding: '15px' }}>
              <div>
                <span className="text-xs font-bold uppercase tracking-widest text-emerald-400 font-mono">Atmospherics</span>
                <h3 className="text-lg font-bold text-white mt-2 mb-4" style={{color: 'white'}}>Extended Sensors</h3>
