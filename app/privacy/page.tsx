     ...
     <article>
        <div className="max-w-7xl mx-auto">
          <div className='maincontent'>
            ...
            <p>
              This Privacy Statement applies to Personal Information collected or managed by SaaSy
            ...
            <p>
              SaaSy does not have a direct relationship with many of the individuals whose Personal
            ...
            <p>
              ...
              sources and, by making use of the data source integrations offered by SaaSy, you
            ...
            <p>
              Also, in addition to the normal SaaSy procedure for deleting Processed Data stored within
            ...
            <p>
              SaaSy does not control what information a Customer chooses to include in Processed Data.
              ...
              Data. All Customers and their provisioned users should understand that data in SaaSy can
            ...
            <ul>
              ...
              <li><strong>Information provided by the Customer and its provisioned users in connection with any support given by the SaaSy team related to the Services:</strong> To resolve problems raised by the Customer or to improve the service based on Customer feedback</li>
              <li><strong>Login information for third party integrations to SaaSy, such as usernames and encrypted passwords:</strong> To connect to 3rd party services on behalf of the Customer in order to provide the Services</li>
            </ul>
            <p>
              As stated in more detail in our Terms of Service, Processed Data is only processed by
              SaaSy on behalf of our Customers to provide them with the Services. Individual provisioned
            ...
            <p>
              In accordance with our Terms of Service, SaaSy may use de-identified and/or aggregate
            ...
            <ul>
              ...
              <li>For commercial purposes, either for SaaSy or for others.</li>
            </ul>
            <p>
